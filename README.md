# Welcome to the RDF4J Test Suite repository

[![Build Status](https://travis-ci.org/eclipse/rdf4j-testsuite.svg?branch=master)](https://travis-ci.org/eclipse/rdf4j-testsuite)

This is the test suite repository for the Eclipse RDF4J project. Please see
...
2. Create an issue in the [RDF4J GitHub issue tracker](https://github.com/eclipse/rdf4j-testsuite/issues) that describes your improvement, new feature, or bug fix.
